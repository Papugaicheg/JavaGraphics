...
class Ideone {
    ...
    public static Map main(String s, Double i) {
        Map<Double,Double> arr = new HashMap<Double,Double>();

            String xs = s.replace("x",String.valueOf(i));
            System.out.println();
            System.out.println("i = "+i);
            Test n = new Test();
            List<String> expression = n.parse(xs);
            boolean flag = n.flag;
            if (flag) {
                System.out.print(xs);
                arr.put(Double.valueOf(i),calc(expression));
